import { humanizeFilmDate, formatFilmDuration} from '../utils';
const createFilmDetailsInfoTemplate = (film) => {
  const {title, alternativeTitle, totalRating, ageRating, director, writers,
    actors, release, runtime, genre, description, poster} = film.filmInfo;
  return `
